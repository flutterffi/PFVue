...
- added reusable section and state components for a more maintainable app structure
- added reusable loading skeletons and clearer dashboard section grouping
...
- added runnable practice lessons for foundations, intermediate JavaScript, and Vue 3 core
- improved the table, form, and dialog lesson with edit, delete, filter, validation, cancel flow, and localStorage persistence

## v0.2.0

- added the first runnable project: component playground
